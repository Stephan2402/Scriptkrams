...
#Variables
$LogFile = "GPOLog.txt"
$sourcedomain = "dom01.kaba.grp"
$targetdomain = "ddc.mydorma.com"
$csvfilepath = "GPO-Migration-list.csv"
$backuppath = "C:\temp\GPOs\GPOs"
$PermissionGroup1 = "RG-CHRMA-SPG-LocalSupporter"
$PermissionGroup2 = "RG-CHRMA-GPADM"
